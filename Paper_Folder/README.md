...
The .zip file with name " all_SEDs_Chi_50+residuals+plots " contains { residual plots + asdf files + corner plots } for various pysersic profiles, comprising:
...
- bulge-disk decomposition (indicate as "_bulge" files) with single Sérsic profile and masking.
In the zip files are also present the SEDs: the "good" ones in a separate inner folder, analyzed with pysersic and all the others selected with UVJ box + mass cut + chi square cut.
